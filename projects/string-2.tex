...
\item{\st{Plot amplitude vs. period for several different values of the amplitude at moderate tension ($L/L_0 \approx 1.1$), going roughly from small $A$ to $A=0.4L$. (Include enough points that the character is clear.) Does your period give you the expected value for small amplitude?
...
simulation, rather than by any amplitude effects. You will want to minimize these as best you can.) How does $\Delta \tau$ depend on amplitude? Comment on similarities and differences between this project and the pendulum project.
